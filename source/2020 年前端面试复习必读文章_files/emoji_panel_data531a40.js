...
function a(e){
i(e.init),n(e.destroy),"function"==typeof e.init&&e.init(!0);
}
function r(e){
if(!w){
if(w=!0,console.warn("[Lifecycle Manager] Start to switch to",e),f.leaveReportNowForSwitchVideo(),
!d)return void s.loadNewPageKeepingHistoryStackIfSecOpen(e);
var n=3e3,i=2,a=0,r=null,g=function(){
if(a===i){
try{
r=JSON.parse(r);
}catch(n){
...
t();
var c=l.getParams(location.href);
window.__initGlobalData(r,c),window.__initCgiDataConfig(r,c),window.__initCommentConfig(r,c),
o(),w=!1,console.warn("[Lifecycle Manager] Finish to switch to",e);
}else s.loadNewPageKeepingHistoryStackIfSecOpen(e);
}
},p=setTimeout(function(){
s.loadNewPageKeepingHistoryStackIfSecOpen(e);
},n),_=function m(e){
document.removeEventListener("WeixinJSBridgeAuthChanged",m),console.warn("[Lifecycle Manager] GetA8Key Success",e.state),
history.replaceState(null,"",e.fullUrl),clearTimeout(p),delete window.__second_open__,
a++,g();
};
document.addEventListener("WeixinJSBridgeAuthChanged",_),history.replaceState(null,"",e);
var y=function S(){
document.removeEventListener("WeixinJSBridgeSpaHistoryChanged",S),console.warn("[Lifecycle Manager] History Stack Changed"),
u.invoke("doAuthCurrentUrl",{},function(e){
e&&e.err_msg&&-1!==e.err_msg.indexOf(":ok")&&console.warn("[Lifecycle Manager] Invoke GetA8Key Success",e);
});
};
document.addEventListener("WeixinJSBridgeSpaHistoryChanged",y),c({
type:"GET",
url:e,
async:!1,
timeout:2e3,
success:function(e){
r=e,console.warn("[Lifecycle Manager] Get PageData",r.substring(0,30)+" ..."),a++,
g();
},
error:function(){
s.loadNewPageKeepingHistoryStackIfSecOpen(e);
...
var c=e("biz_wap/utils/ajax.js"),s=e("common/utils.js"),u=e("biz_wap/jsapi/core.js"),l=e("pages_new/modules/utils/url.js"),f=e("pages/video_collection/report.js"),d=!1,g=[],p=[],w=!1;
return{
register:a,
openNewVideoPage:r
};
